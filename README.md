...
* To run this, you need python, which can be downloaded [here](https://www.python.org/).
  ...
  * Into the command prompt type `cd "C:\<full_path_to_where_you_put>\libby_calculator.py"` (replace the file path accordingly) and press enter.
  * Then type `python libby_calculator.py` and press enter.
# Button Behaviors
